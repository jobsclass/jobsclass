...
CREATE TABLE IF NOT EXISTS customers (
  ...
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE, -- 파트너 (상품 판매자)
  ...
  -- 문의 내용
  message TEXT,
  service_id UUID REFERENCES services(id) ON DELETE SET NULL, -- 문의한 서비스
...
COMMENT ON TABLE customers IS '고객 문의 및 연락처 관리';
